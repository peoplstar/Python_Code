...
|<img src="[random_ex](https://github.com/peoplstar/Python_Code)/int(random()).png" width="80%" height="100%" alt="int(random())"></img>|<img src="random_ex/randrange().png" width="85%" height="100%" alt="randrange()"></img>|<img src="random_ex/randint().png" width="90%" height="100%" alt="randint()"></img>|   
|:---:|:---:|:---:|
