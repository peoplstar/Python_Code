...
|<img src="random_ex/int(random()).png" width="80%" height="100%" alt="int(random()"></img>|<img src="random_ex/int(random()).png" width="85%" height="100%" alt="int(random()"></img>|<img src="random_ex/int(random()).png" width="90%" height="100%" alt="int(random()"></img>|   
|:---:|:---:|:---:|
